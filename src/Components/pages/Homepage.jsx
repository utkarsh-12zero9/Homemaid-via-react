...
function Homepage() {
    return (
        <div className="min-h-screen bg-gradient-to-br from-teal-50 to-blue-100">
            {/* Hero Section (Consistent height) */}
            <div className="bg-[#00246B] min-h-[80vh] text-white py-16 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center">
                    <div className="md:w-1/2 text-center md:text-left lg:mb-8 md:mb-4">
                        ...
                        <p className="text-lg sm:text-xl font-poppins text-gray-200 mb-6">
                            Your trusted platform for home services – book maids, cooks, and
                            more! Enjoy reliable, vetted providers, a wide range of tasks, and
                            hassle-free booking from the comfort of home.
                        </p>
                        <Link
                            to="/services"
                    ...
                    <div className="md:w-1/2">
                        <img
                            ...
                            className="min-h-[68vh] sm:h-64 md:h-80 lg:h-96 object-contain rounded-lg mx-auto shadow-md mt-5"
                        />
                    </div>
                </div>
            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-white p-6 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 border border-teal-200">
                            <p className="text-gray-600 font-poppins italic mb-4">
                                "HomeMaid made my life so easy! The cook they sent was amazing,
                                and booking was a breeze."
                            </p>
                            <p className="font-bold text-teal-800 font-poppins">
                                Ravi Sharma, Homeowner
                            </p>
                        </div>
                        <div className="bg-white p-6 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 border border-teal-200">
                            <p className="text-gray-600 font-poppins italic mb-4">
                                "Reliable maids and great support. Highly recommend for anyone
                                needing home help!"
                            </p>
                            <p className="font-bold text-teal-800 font-poppins">
                                Priya Patel, Working Mom
                            </p>
                        </div>
                        <div className="bg-white p-6 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 border border-teal-200">
                            <p className="text-gray-600 font-poppins italic mb-4">
                                "The cleaning service was top-notch, and the process was so
                                simple. Will use again!"
                            </p>
                            <p className="font-bold text-teal-800 font-poppins">
                                Amit Verma, Busy Professional
                            </p>
                        </div>
                        <div className="bg-white p-6 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 border border-teal-200">
                            <p className="text-gray-600 font-poppins italic mb-4">
                                "Fantastic experience with the laundry service—quick and
                                efficient!"
                            </p>
                            <p className="font-bold text-teal-800 font-poppins">
                                Neha Gupta, Student
                        ...
                        <div className="bg-white p-6 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 border border-teal-200">
                            ...
                            <p className="font-bold text-teal-800 font-poppins">
                                Sanjay Kumar, Office Worker
                            </p>
                        </div>
                        <div className="bg-white p-6 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 border border-teal-200">
                            <p className="text-gray-600 font-poppins italic mb-4">
                                "Booking a maid was seamless, and the service exceeded my
                                expectations!"
                            </p>
                            <p className="font-bold text-teal-800 font-poppins">
                                Anjali Desai, Retiree
                            </p>
                        </div>
                        <div className="bg-white p-6 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 border border-teal-200">
                            <p className="text-gray-600 font-poppins italic mb-4">
                                "Great value for money—my home feels spotless after every
                                visit!"
                            </p>
                            <p className="font-bold text-teal-800 font-poppins">
