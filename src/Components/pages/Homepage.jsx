...
// Homepage component: Hero + Providers + Static Testimonials
function Homepage() {
    return (
        <div className="min-h-screen bg-gray-100">
                ...
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center">
                    ...
                    <div className="md:w-1/2">
                        <img
                            ...
                            className="min-h-[73vh] sm:h-64 md:h-80 lg:h-96 object-contain rounded-lg mx-auto"
                        />
                    </div>
                </div>
            </div>
            ...
            <div className="py-12 px-4 sm:px-6 lg:px-8 bg-gray-200">
                <h2 className="text-3xl sm:text-4xl font-bold text-[#00246B] font-poppins text-center mb-10">
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-white p-6 rounded-lg shadow-md">
                            ...
                            <p className="font-bold text-[#00246B] font-poppins">Ravi Sharma, Homeowner</p>
                        </div>
                        <div className="bg-white p-6 rounded-lg shadow-md">
                            <p className="text-gray-600 font-poppins italic mb-4">
                                "Reliable maids and great support. Highly recommend for anyone needing home help!"
                            </p>
                            <p className="font-bold text-[#00246B] font-poppins">Priya Patel, Working Mom</p>
                        </div>
                        <div className="bg-white p-6 rounded-lg shadow-md">
                            <p className="text-gray-600 font-poppins italic mb-4">
                                "The cleaning service was top-notch, and the process was so simple. Will use again!"
                            </p>
                            <p className="font-bold text-[#00246B] font-poppins">Amit Verma, Busy Professional</p>
                        </div>
                        <div className="bg-white p-6 rounded-lg shadow-md">
                            <p className="text-gray-600 font-poppins italic mb-4">
                                "Fantastic experience with the laundry service—quick and efficient!"
                            </p>
                            <p className="font-bold text-[#00246B] font-poppins">Neha Gupta, Student</p>
                        </div>
                        <div className="bg-white p-6 rounded-lg shadow-md">
                            <p className="text-gray-600 font-poppins italic mb-4">
                                "The dusting team was thorough and friendly—highly satisfied!"
                            </p>
                            <p className="font-bold text-[#00246B] font-poppins">Sanjay Kumar, Office Worker</p>
                        </div>
                        <div className="bg-white p-6 rounded-lg shadow-md">
                            <p className="text-gray-600 font-poppins italic mb-4">
                                "Booking a maid was seamless, and the service exceeded my expectations!"
                            </p>
                            <p className="font-bold text-[#00246B] font-poppins">Anjali Desai, Retiree</p>
                        </div>
                        <div className="bg-white p-6 rounded-lg shadow-md">
                            <p className="text-gray-600 font-poppins italic mb-4">
                                "Great value for money—my home feels spotless after every visit!"
                            </p>
                            <p className="font-bold text-[#00246B] font-poppins">Vikram Singh, Entrepreneur</p>
                        </div>
                    </div>
                </div>
            </div>
