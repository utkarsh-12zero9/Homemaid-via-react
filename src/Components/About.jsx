  ...
  return (
    <>
      <div className="mx-auto h-screen mt-20 max-w-screen-xl p-10">
        ...
        <p className="w-[83%] text-xl text-black leading-9 flex font-semibold mb-10 ml-7">
        ...
        <p className="w-[85%] ml-7 text-2xl text-black leading-5 mb-10 flex font-semibold ">
